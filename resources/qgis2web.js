...
map.getView().fit([1711913.398474, 6697415.368387, 1714953.996912, 6698705.116598], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Autostrada A18 km 50+000 - 54+950</h2>';
        return titleElement;
    })(),
